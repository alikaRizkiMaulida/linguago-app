                                  ...
                                  if (stepType == 1) {
                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute<void>(
                                        builder: (_) => LessonDetailPage(part: stepNum),
                                      ),
                                    ).then((_) => setState(() {}));
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute<void>(
                                        builder: (_) => QuizIntroPage(level: levelNum),
                                      ),
                                    ).then((_) => setState(() {}));
                                  } else if (stepType == 4) {
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute<void>(
                                        builder: (_) => FunFactPage(part: stepNum),
                                      ),
                                    ).then((_) => setState(() {}));
                                  }
                                }
                                ...
                                onTap: () {
                                  ...
                                  if (stepType == 1) {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute<void>(
                                        builder: (_) => LessonDetailPage(part: unlocked),
                                      ),
                                    ).then((_) => setState(() {}));
                                  } else if (stepType == 2 || stepType == 3 || stepType == 0) {
                                    Navigator.push(
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute<void>(
                                        builder: (_) => FunFactPage(part: unlocked),
                                      ),
                                    ).then((_) => setState(() {}));
                                  }
                                },
