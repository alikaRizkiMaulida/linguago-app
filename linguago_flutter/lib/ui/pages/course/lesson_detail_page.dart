...
class LessonDetailPage extends StatefulWidget {
  final int part;
  const LessonDetailPage({super.key, this.part = 1});
...
class _LessonDetailPageState extends State<LessonDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isSaved = LessonDetailPage.savedLessonsData.any(
                          ...
                          onPressed: () {
                            setState(() {
                              if (isSaved) {
                                ...
                                LessonDetailPage.savedLessonsData.removeWhere(
                                  (element) => element['title'] == data['title'] && element['ytId'] == data['ytId'],
                                );
                              } else {
                                // Jika belum di-save, masukkan ke list
                                LessonDetailPage.savedLessonsData.add(data);
                              }
                            });
                          },
                        ),
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute<void>(builder: (_) => QuizPage(part: quizPart)),
                          );
                        },
                        child: const Text(
                          'Start Quiz',
