...
// Import file LessonDetailPage agar bisa membaca data list static-nya
...
class _SavedLessonsPageState extends State<SavedLessonsPage> {
  ...
  Widget build(BuildContext context) {
    // Mengambil data real-time dari LessonDetailPage
    final List<Map<String, dynamic>> savedLessons = LessonDetailPage.savedLessonsData;
                ...
                itemBuilder: (context, index) {
                  ...
                  return LessonCard(
                    ...
                    onUnsave: () {
                      ...
                      setState(() {
                        LessonDetailPage.savedLessonsData.removeAt(index);
                      });
                    },
                  );
                },
