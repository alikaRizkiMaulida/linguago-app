...
import 'package:linguago_flutter/ui/pages/streak/streak_page.dart';
import 'package:linguago_flutter/ui/pages/listening/listening_category_page.dart' as linguago_flutter_listening;
import 'package:linguago_flutter/ui/pages/script/script_category_page.dart' as linguago_flutter_script;
import 'package:linguago_flutter/ui/pages/quiz/quiz_intro_page.dart';
import 'package:linguago_flutter/ui/pages/course/lesson_detail_page.dart';
import 'package:linguago_flutter/ui/pages/quiz/fun_fact_page.dart';
import 'package:linguago_flutter/ui/pages/quiz/quiz_page.dart';
import 'package:linguago_flutter/ui/pages/profile/my_coins_page.dart';
import 'package:linguago_flutter/ui/pages/leaderboard/leaderboard_page.dart';
import 'package:linguago_flutter/data/datasource/auth_local_datasource.dart';


/// Home Page — konten tab pertama di HomeShellPage.
/// Dipisah dari home_shell_page.dart supaya lebih mudah dibaca dan dikelola.
                        ...
                        onTap: () {
                          ...
                          if (unlocked == 1) {
                            Navigator.push(
                              context,
                              MaterialPageRoute<void>(
                                builder: (_) => const LessonDetailPage(part: 1),
                              ),
                            );
                          } else if (unlocked == 2) {
                            Navigator.push(
                              context,
                              MaterialPageRoute<void>(
                                builder: (_) => const QuizPage(part: 1),
                              ),
                            );
                          } else if (unlocked == 3) {
                            Navigator.push(
                              context,
                              MaterialPageRoute<void>(
                                builder: (_) => const QuizPage(part: 2),
                              ),
                            );
                          } else if (unlocked == 4) {
                            Navigator.push(
                              context,
                              MaterialPageRoute<void>(
                                builder: (_) => const FunFactPage(part: 4),
                              ),
                            );
                          } else {
                            Navigator.push(
                              context,
                              MaterialPageRoute<void>(
                                builder: (_) => const QuizPage(part: 5),
                              ),
                            );
                          }
                        },
            ...
            child: _QuickActionCard(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute<void>(
                        builder: (_) => const linguago_flutter_listening.ListeningCategoryPage()),
                  ).then((_) => onRefresh());
                })),
        const SizedBox(width: 12),
        Expanded(
            child: _QuickActionCard(
                ...
                onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute<void>(
                          builder: (_) => const linguago_flutter_script.ScriptCategoryPage()),
                    ).then((_) => onRefresh()))),
        const SizedBox(width: 12),
        Expanded(
            child: _QuickActionCard(
  ...
  void _onNodeTap(BuildContext context, int nodeIndex) {
    ...
    if (nodeIndex == 0) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute<void>(
          builder: (_) => const LessonDetailPage(part: 6),
        ),
      ).then((_) => setState(() {}));
    } else if (nodeIndex == 6) {
      // Node 7 → Quiz Level 2
      Navigator.push(
        context,
        MaterialPageRoute<void>(
          builder: (_) => const QuizIntroPage(level: 2),
        ),
      ).then((_) => setState(() {}));
    } else if (nodeIndex == 7) {
      // Node 8 → Quiz Level 2
      ...
      Navigator.push(
        context,
        MaterialPageRoute<void>(
          builder: (_) => const FunFactPage(part: 9),
        ),
      ).then((_) => setState(() {}));
    } else if (nodeIndex == 9) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute<void>(
          builder: (_) => const QuizPage(part: 10),
        ),
      ).then((_) => setState(() {}));
    }
  }
