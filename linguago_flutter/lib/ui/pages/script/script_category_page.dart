...
class ScriptCategoryPage extends StatefulWidget {
  const ScriptCategoryPage({super.key});

  @override
  State<ScriptCategoryPage> createState() => _ScriptCategoryPageState();
}

class _ScriptCategoryPageState extends State<ScriptCategoryPage> {
...
class _ScriptCard extends StatelessWidget {
  ...
  void _navigateToLesson(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => LessonDetailPage(part: lockLevel),
      ),
    ).then((_) {
      onRefresh();
    });
