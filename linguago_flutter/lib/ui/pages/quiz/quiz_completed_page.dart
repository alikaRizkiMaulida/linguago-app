...
class QuizCompletedPage extends StatefulWidget {
  final int part;
  ...
  @override
  State<QuizCompletedPage> createState() => _QuizCompletedPageState();
}

class _QuizCompletedPageState extends State<QuizCompletedPage> with TickerProviderStateMixin {
