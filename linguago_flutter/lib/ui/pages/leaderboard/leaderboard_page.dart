...
class _LeaderboardPage extends StatefulWidget {
  ...
  @override
  State<_LeaderboardPage> createState() => _LeaderboardPageTabState();
}

class _LeaderboardPageTabState extends State<_LeaderboardPage> {
              ...
              GestureDetector(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => FriendRecommendationPage(
                        recs: recs,
...
// ─── Friend Recommendation Page ──────────────────────────────────────────────
class FriendRecommendationPage extends StatelessWidget {
  final List<_Friend> recs;
  final Function(_Friend) onShowProfileCard;
