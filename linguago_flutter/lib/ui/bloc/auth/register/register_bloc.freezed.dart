...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Started value)?  started,TResult Function( _RegisterSubmitted value)?  registerSubmitted,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _RegisterSubmitted() when registerSubmitted != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Started value)  started,required TResult Function( _RegisterSubmitted value)  registerSubmitted,}){
final _that = this;
switch (_that) {
case _Started():
return started(_that);case _RegisterSubmitted():
return registerSubmitted(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Started value)?  started,TResult? Function( _RegisterSubmitted value)?  registerSubmitted,}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _RegisterSubmitted() when registerSubmitted != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( String name,  String email,  String password)?  registerSubmitted,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _RegisterSubmitted() when registerSubmitted != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function( String name,  String email,  String password)  registerSubmitted,}) {final _that = this;
switch (_that) {
case _Started():
return started();case _RegisterSubmitted():
return registerSubmitted(_that.name,_that.email,_that.password);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( String name,  String email,  String password)?  registerSubmitted,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _RegisterSubmitted() when registerSubmitted != null:
return registerSubmitted(_that.name,_that.email,_that.password);case _:
...
class _RegisterSubmitted implements RegisterEvent {
  const _RegisterSubmitted({required this.name, required this.email, required this.password});
